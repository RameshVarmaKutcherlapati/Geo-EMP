...
public GeographyMessageData getGeographyMessage(String geoRowID, String eventDetails) throws Exception {
    ...
    GeographyParentDetailsData geographyParentDetailsData = GeographyParentDao.retrieveParentDetailsByGeoRowId(geoRowID,geoRowID);

    List<GeographyParentAlternateCodeData> geographyParentAlternateCodeData = GeographyParentAltCdDao.retrieveParentAltCodeDtlsByParentId(geoRowID);

    geographyParentDetailsData.setParentAlternateCode(geographyParentAlternateCodeData);
    ...
    return GeographyMessageData.builder().geographyData(geography.builder()
                    ...
                    .parentDetails(geographyParentDetailsData)
